...
Page({
    ...
    itemAction(e) {
        ...
        for (var i = 0; i < items.length; i++) {
            if (items[i].isDefault) {
                price += items[i].cus_price * items[i].goods_number;
            }
        }
        this.setData({
            items,
    ...
    QueryList() {
        var that = this;
        wx.request({
            url: api.apiServer + "?s=Wechat.Item.QueryList",
            method: "GET",
            data: {
    ...
    DeleteCart(goods_id) {
        var that = this;
        wx.request({
            url: api.apiServer + "?s=Wechat.Item.Delete_cart",
            method: "POST",
            data: {
                unionid: that.data.userInfo.unionid,
                goods_id
    ...
    EditNum(goods_id, goods_num) {
        var that = this;
        wx.request({
            url: api.apiServer + "?s=Wechat.Item.EditNum",
            method: "POST",
            data: {
                unionid: that.data.userInfo.unionid,
                goods_id,
    ...
    CreateCart(goods_id, goods_num) {
        ...
        var that = this;
        wx.request({
            url: api.apiServer + "?s=Wechat.Item.CreateCart",
            method: "POST",
            data: {
                unionid: that.data.userInfo.unionid,
                goods_id,
