...
Page({
    ...
    deleteAction() {
        ...
        wx.showModal({
            ...
            success(res) {
                if (res.confirm) {
                    wx.request({
                        url: api.apiServer + "?s=Wechat.Customer.DelAddress",
                        method: "POST",
                        data: {
    ...
    province(provinceId) {
        var that = this;
        wx.request({
            url: api.apiServer + "?s=Wechat.Jdapi.Query",
            method: "POST",
            data: {
                action: "province",
            },
    ...
    AddJdAddress(openid, receiver, mobile, province, city, area, town, provinceId, cityId, areaId, townId, address) {
        ...
        wx.request({
            url: api.apiServer + "?s=Wechat.Customer.AddJdAddress",
            method: "POST",
            data: {
                unionid: that.data.userInfo.unionid,
                receiver,
    ...
    UpdJdAddress(openid, receiver, mobile, province, city, area, town, provinceId, cityId, areaId, townId, address, address_id) {
        ...
        wx.request({
            url: api.apiServer + "?s=Wechat.Customer.UpdJdAddress",
            method: "POST",
            data: {
                unionid: that.data.userInfo.unionid,
                receiver,
